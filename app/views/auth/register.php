<div style="display:flex;justify-content:center;align-items:center;min-height:70vh">
    <div style="background:var(--color-bg-card, #fff);border-radius:12px;padding:2.5rem;width:100%;max-width:420px;box-shadow:0 4px 24px rgba(0,0,0,0.08)">
        <h2 style="margin-bottom:1.5rem;font-size:1.5rem"><?= e(t('auth.register')) ?></h2>
        ...
        <form method="POST" action="/register">
            ...
            <div style="margin-bottom:1rem">
                <label for="name" style="display:block;margin-bottom:0.4rem;font-size:0.875rem;font-weight:500">
                    <?= e(t('auth.name')) ?>
                </label>
        ...
        <p style="margin-top:1.25rem;text-align:center;font-size:0.875rem;color:var(--color-text-muted)">
            <?= e(t('nav.login')) ?>?
            <a href="/login" style="color:var(--color-accent)"><?= e(t('auth.login')) ?></a>
        </p>
    </div>
</div>
